...
# Ввод строки и разбивка её на элементы
# text = [num for num in input().split()]

# # Создание списка квадратов чётных чисел, которые не оканчиваются на цифру 4
# result = [str(int(n) ** 2) for n in text if int(n) % 2 == 0 and (int(n) ** 2) % 10 != 4]
